...
<section id="update">
	...
	<?php echo form_open_multipart("member/update",'class="form-horizontal"');?>
	<div class="container">
		<h1>Update</h1>
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group">
		    		...
		    		<div class="col-sm-6">
		      			<textarea class="form-control inputform" rows="3" name="text" required><?php echo $r->username; ?></textarea> 
		  			 </div>
		  		</div>
		  		<div class="form-group">
